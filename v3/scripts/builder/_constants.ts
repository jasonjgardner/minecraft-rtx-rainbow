...
export const ADDON_DIR = join(ROOT_DIR, "bedrock/BP/rainbow-addon");
export const RP_DIR = join(ROOT_DIR, "bedrock/RP");
export const BP_DIR = join(ROOT_DIR, "bedrock/BP");

export const sizes: PackSizes[] = [16, 32, 64, 128, 256, 512, 1024];

export const NAMESPACE = "rainbow";

export const TARGET_VERSION = [1, 21, 120];

export const BLOCK_VERSION = "1.21.120";
